...
% TODO: should I add in some figures to outline these relationships? 
...
% TODO define big data sources , are we just talking about digital trace data? what is that? Define, even if as footnote. Are 10K pages of field notes big data? Admin data with millions of observations but no text? 

% TODO Define digital trace data. I  assume remnants of digital activity archived by corporate or state entities.
...
% TODO Does this just mean free and publicly available?
...
% TODO finish this sentence, This is the framework I would use for identifying ‘best practices.’ I would personally just say here is how this can go wrong, here is how you avoid it, and next steps. I could see doing a critical spin off for a place like big data and society.
...
% TODO I’ll just say, while I think there is utility here, it is a very particular aspect of culture in a specific populations. I think we are still in the era where the bigness and newness can overshadow truth value.
...
% TODO I think this may erode your point about increasing legitimacy. If you said JAMA or NEJM, that would be a stronger example. If not, I’d just point to some specific projects then say new journals have emerged but that does not indicate mainstream acceptance…
...
% TODO I know it is basic stats, but I would provide a footnote explaining each of your terms. Here, these line up with mainline stats but disciplines vary.
...
% TODO Yes, big issue. But, it is also seen in machine learning, survey administration, etc. I’d assume one solution for dealing with fiddly output is to just sample repetedly and do some sort of average, perhaps with a correction if the direction of the error is non random.
...
% TODO I’d also say, the population is examined differently. It is really a population of action remnants being used to get at a population of people, which is presumed to be represented online.
...
%TODO CITE above, For a soc audience some sort of reference to the dilemma of interpretation would be interesting.
...
%TODO There are a lot of validities here. Be precise and explain what you are concretely examining. define which validity here 
...
% TODO create a  table People will want to see a table of variables, their prompts, and ranges.
...
% TODO Also blatant political interference in some places, which is probably worth acknowledging.
...
%TODO This all sounds fine to me, but I’m less up to date on model specification and nesting, so I’m not the best to ask. I would also specify why these models are appropriate in one sentence max because methods people about these things. Also,they may have sampling assumptions the data violate so clarifying that that is not an issue may be necessary.   
...
% TODO Why? To have a standardized net impact? Sociologists usually have a strong negative reaction to this. In contrast, in psych they do this with everything.  
...
% While I would like to be able to join \citet{bailCulturalEnvironmentMeasuring2014} 
...
% TODO I like this, but it is out of place tone-wise. It fits better in a critical piece or blog. I’d say something like in these cases, GT fails validation tests, and caution future research is warranted. Future research should determine its utility using empirical criteria rather than a prior assumptions. Triangulation, using various data sources, is necessary.

% A stronger case, if you wanted to go in calling out the big data evangelicals, would be to show that their own work does not replicate or those measures are invalid. 

% Some of this is based in logical errors and some is based in the politics, and there are different ways to treat that.