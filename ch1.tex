...
In academia and policy, the focus in research on information has always
...
A critical turning point in the study of the flow of information was put forth by
...
I have only discussed the way that information is passively
consumed through push efforts by opinion leaders and social networks. However,
sociological literature is sparse on the opposite behavior: active
...
based on associations without planning. Another strategy is analytical,
...
\citep{fryeCulturalMeaningsAggregation2017}. Importantly,
people look to others performing an action and often
...
the theoretical framework (Figure \ref{fig:concept-map}).
...
Computational social science and social science disciplines are quick to adopt new
sources of digital trace data for use in academic research. In this article, I
examine the criterion validity of one of these new sources, Google Search Trends. I
validate how Google Trends can be used to demonstrate three different cases,
namely attitudes, disease prevalence and political preferences using five
...
demographic variables. This article shows that there is no external or 
criterion validity of Google Trends for these uses and social scientists will find no replacement for
...
with each information seeking modality: personal connection,
...
different from each other and that the utilization of different modalities varies
by demography and information exposure points. Finally, I find that different
exposure points and information search modalities hold real world consequences
...
both stay-at-home rates and vaccination rates as responses to public health recommendations to mitigate the COVID-19 pandemic. Using theories like associative diffusion
...
signals received by an ego. If there is diversity in the information received
by an ego, contagion is less likely to occur. This paper shows that the contagion 
process cannot be not fully understood without looking at the context of each
exposure to a contagion within  within the range of contagions one experiences. 
...
Bridging the contribution of search as an agentic process 
