...
people rely on this information and to inform their
...
\citep{sparrow2011google} - memory is worse, reliance on technology
...
opportunities \citep{granovetterGettingJobStudy1995, montgomeryJobSearchNetwork1992}, how 
information spreads best when weak and strong ties are balanced (embeddedness) \citep{uzziSocialStructureCompetition1997}, and more recent innovations in the stickiness of complex contagion \citep{centolaComplexContagionsWeakness2007}.
...
information. \citep{pejtersenDesignComputeraidedUsersystem1984}, a
scholar of library and information
...
validated the framework \citep{fidelHumanInformationInteraction2012}; the frame is a
useful beginning point for my theories of information search through 
network activation or through computer-mediated communication.

\subsection{Information Search in The Digital Age}
computer-mediated information search - as in the pre-internet age, you could find information without asking a friend or an expert. encyclopedias.. etc. 


computer mediated communication 

Social media...  \citep{bayer_etal20}
"“Social media are Internet-based, disentrained, and persistent channels of
masspersonal communication facilitating perceptions of interactions 
among users, deriving value primarily from user-generated content.” \citep[][p. 50]{carr2015social}

Social Networking Site - profile, stream , network, messaging \citep{boyd2007social, ellison2013sociality}

integration of the one-to-one communication formations (face-to-face, letters, texting) within the context of one-to-many forms of communication (television, radio) \citep{o2018masspersonal}
...
outcomes \citep{houseMeasuresConceptsSocial1985, thoitsMechanismsLinkingSocial2011}.
...
Indeed, much research has revealed the higher levels of social capital of Facebook users \citep{liu2016meta}, with findings indicating that using SNSs to find information and relationship maintenance indicating the highest levels of bridging capital.  
...
ties \citep{baumeister,grieve2013face} but search will be conducted online when 
...
\subsection{new literature to add}

\citet{bayer_etal20}
profiles and self-presentation
networks and social mobilization
streams and social comparison
messages and social connectedness 


\citet{bossetta18}
"tools that are easy to use and functional to the demands of varying using demographics"
"digital architecture - the technical protocols that enable, constrain and shape user behavior in a virtual space"
Different platforms deliver different user experiences along the dimensions of searchability, connectivity, and privacy


\citet{boyd2010social}
"Networked publics serve many of the same functions as other types of publics – they allow people to gather for social, cultural, and civic purposes and they help people connect with a world beyond their close friends and family. " p 39
...
interpretation of actions of others \citep{weber1978economy}. 
...
for the research question in \hyperlink{paper-3}{Paper 3}. The Relational argument 
