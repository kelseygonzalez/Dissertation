...
The survey took an average of 24.48 minutes with a standard deviation of 13.23 minutes.
...
\input{tables/paper2/table-1-ind}
...
\input{tables/paper2/table-2-dep}
...
not (\emph{p} \textless{} 0.001). However, receiving information from other modalities also
...
I also wanted to examine what factors were associated with posting in an online discussion
...
I first find that being exposed to information about COVID-19 vaccinations from any 
